...
class Produksi extends CI_Controller
{
    ...
    public function get_productions_by_machine($machine_id)
    {
        $data = $this->Produksi_model->get_productions_by_machine($machine_id);
        if($data){
            ...
            foreach ($data as $key => $value) {
                $page.='
                <tr>
                    <td><a href="#" class="detail-produksi" id="'.$value->id.'" style="color: white;">'.$value->kd_order.'</a></td>
                    <td>'.$value->status.'</td>
                    <td>'.$value->rencana_selesai.'</td>
                </tr>
                ';
            }
