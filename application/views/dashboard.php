    ...
    <div class="col-xl-3 col-md-6">
        <div class="widget widget-stats bg-blue">
            ...
            <div class="stats-info">
                <h4>TOTAL USERS LOGIN</h4>
                <p><?php echo $classnyak->showtotallogin(date('d'))->tl ?></p>
            </div>
...
<div class="row">
    ...
    <div class="col-xl-8">
        ...
        <div class="tab-content bg-black-transparent-2 rounded-bottom mb-20px" data-sortable-id="index-3">
...
<textarea class="form-control rounded-0 border-0 shadow-none p-3" rows="14">Enter some comment.</textarea>
