<div id="content" class="app-content">
        ...
        <script type="text/javascript">
            ...
            $(document).on('click','.tambah_data', function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo base_url() ?>mesin/create",
            ...
            $(document).on('click','.list-data', function(e) {
                ...
                $.ajax({
                    type: "GET",
                    url: "<?php echo base_url() ?>mesin/list",
                    success: function(data){
                        $('#panel-body').html(data);
                    },
                    error: function(error) {
            ...
            $(document).on('click','.read_data', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>mesin/read",
                    data: {
                        id:id,
                    },
                    success: function(data){
            ...
            $(document).on('click','.update_data', function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>mesin/update",
                    data: {
                        id:id,
                    },
                    success: function(data){
            ...
            $(document).on('click','.delete_data', function() {
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url() ?>mesin/delete",
                        data: {
                            id:id,
                        },
                        success: function(data){
            ...
            $(document).on('submit','#form_create_action', function(e) {
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url() ?>mesin/create_action",
                        data: dataString,
                        success: function(data){
                            Swal.fire({
                              icon: 'success',
                              title: "Sukses",
                              text: 'Data mesin berhasil tercatat'
                            })
                            $('#panel-body').html(data);
                        },
                        error: function(error) {
            ...
            $(document).on('submit','#form_update_action', function(e) {
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url() ?>mesin/update_action",
                        data: dataString,
                        success: function(data){
                            Swal.fire({
                              icon: 'success',
                              title: "Sukses",
                              text: 'Data mesin berhasil diupdate'
                            })
                            $('#panel-body').html(data);
                        },
                        error: function(error) {
