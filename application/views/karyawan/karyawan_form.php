...
<div class="panel-body">
	    ...
	    <tr><td >Status Kawin <?php echo form_error('status_kawin') ?></td><td><input type="text" class="form-control" name="status_kawin" id="status_kawin" placeholder="Status Kawin" value="<?php echo $status_kawin; ?>" /></td></tr>
